...
from mainSingleList import SingleList
...
print ("The value 2 appears {:d} times in list".format(single.count( 2 )))
print ("The value 5 appears {:d} times in list".format(single.count( 5 )))
...
print ("The list, after adding elements is:", single)

# remove values from list
popValue = single.pop()
print ("Removed", popValue, "from list:", single)
single.append( popValue )
print ("Added", popValue, "back to end of list:", single)

# slice list
print ("The value of single[ 1:4 ] is:", single[ 1:4 ])
